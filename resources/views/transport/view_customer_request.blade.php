        ...
        <div class="card card-custom gutter-b example example-compact">
            ...
            <form class="form" action="{{route('transporter.preinvoice.update')}}" method="post">
                <div class="card-body justify-content-center">
                    ...
                    @if(!is_null($single->preinvoice->transport))
                        <br><br><br>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <x-FormButton permission="Upload Charge Receipts"
                                                      url="{{route('transporter.uploadChargeReceipts',$single->preinvoice->transport->id)}}"
                        ...
                        <div class="row mt-2">
                            <div class="col-12 m-auto text-center"><img class="img-fluid mr-1 mt-2"
                                                                        src="{{ asset('/storage/'.$single->preinvoice->transport->upload_customer_charge_receipt) }}"
                                                                        alt=""></div>
                        </div>
                    @endif

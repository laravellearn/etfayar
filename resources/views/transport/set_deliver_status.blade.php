...
@section('content')
    <div class="col-lg-12">
        ...
        <div class="card card-custom gutter-b example example-compact">
            <div class="card-header">
                <h3 class="card-title">تعیین راننده تحویل دهنده</h3>
                <div class="card-toolbar">
                    <div class="example-tools justify-content-center">
            ...
            <!--begin::Form-->
            <form class="form" action="{{route('transport.update_delivery_status')}}" method="post">
                <div class="card-body">
...
{{--
                    ...
                    <div id="delivery_status_block" class="form-group row">
                        <label class="col-3">@lang("transporter.delivery_status") <strong>*</strong></label>
                        <div class="col-9">
                            @php($items=[
                                       ['title'=>'در انتظار تعیین راننده ','value'=>'waiting_for_set_deliverer'],
                                       ['title'=>'در انتظار تحویل','value'=>'pending_delivery'],
                            ...
                            <select id="delivery_status" class="form-control" name="delivery_status">
                                @foreach($items as $item)
                                    <option
                                        {{$single->delivery_status==$item['value']?'selected':''}} value="{{$item['value']}}">{{$item['title']}}
                                    </option>
                                @endforeach
                            </select>
                        </div>
...
--}}
                    ...
                    <div id="delivery_driver_block" class="form-group row">
                        ...
                        <div class="col-9">
                            <select id="delivery_driver" class="form-control" name="delivery_driver_id">
                                <option value="" disabled selected hidden>انتخاب راننده تحویل دهنده...</option>

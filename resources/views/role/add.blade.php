                ...
                <div class="card-body">
                    ...
                    <div class="checkbox-list">
                        @foreach($permissions as $permission)
                            <label class="checkbox"> <input type="checkbox" name="permissions[]" value="{{$permission->title}}"> <span></span> {{$permission->persian_title}}
                            </label>
                        @endforeach
                    </div>--}}
                            ...
                            <div class="card m-2">
                                <div class="card-header">
                                    <div class="card-title" data-toggle="collapse"
                                         data-target="#collapse{{$permission->id}}" aria-expanded="true">
                                        {{$permission->persian_title}}
                                    </div>
                                </div>
                                <div id="collapse{{$permission->id}}" class="collapse show"
                                     data-parent="#accordionنمونه1" style="">
                                    <div class="card-body">

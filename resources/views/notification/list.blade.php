                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap py-5">
                        ...
                        <div class="card-toolbar">
                            ...
                            <x-Button permission="Add Request" :title="__('notification.add')"
                                      url="{{route('notification.create')}}"></x-Button>
                    ...
                    <div class="card-body">
                        <!--begin: جدول داده ها-->
                        <table class="table table-separate table-head-custom table-bordered table-striped" id="kt_datatable_requests">
                            <thead>
                            <tr>
                            ...
                            @forelse($list as $item)
                                ...
                                <tr>
                                    ...
                                    <td nowrap>
                                        ...
                                        <x-FormButton permission="Edit Notification"
                                                      url="{{route('notification.edit',$item->id)}}"
                                                      :icon="__('icon.edit_icon')" :title="__('common.edit')"
                                                      click="null">
                                        </x-FormButton>

                                        <x-FormButton permission="Delete Notification" url="javascript:;"
                                                      :icon="__('icon.delete_icon')" :title="__('common.delete')"
                                                      click="deleteDialog('{{__('common.delete')}}','{{__('common.areYouSureDelete')}}','/admin/notification/delete/{{$item->id}}')">
                                        </x-FormButton>
